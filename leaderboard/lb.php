...
<head>
    ...
    <style>
        body {
  background: radial-gradient(#272727, #000);
  height: 100vh;
  padding: 0;
  margin: 0;
  display: flex;
...
<body>
<div class="icon">
  <svg class="numeroUno" width="430" height="430" viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g class="championIcon">
      ...
      <g class="left_branch">
        <g class="stem_rapper">
          <g class="top_leaf">
            <path class="leaf" fill-rule="evenodd" clip-rule="evenodd" d="M5.30008 18L5.80008 16C6.10008 17 6.20008 18.1 6.20008 19.1V19.4C6.00008 20 5.40008 20.4 4.80008 20.3C4.20008 20.2 3.80008 19.6 3.90008 19C4.20008 17.8 4.90008 16.8 5.80008 16L5.30008 18Z" fill="#F2F2F2" />
          </g>
          <g class="left">
            <g class="leaf_rapper">
          ...
          <g class="right">
            <g class="leaf_rapper">
              <path class="leaf" fill-rule="evenodd" clip-rule="evenodd" d="M6.40022 21.9008L8.70022 20.3008C8.10022 21.7008 7.20022 23.0008 6.00022 24.0008C5.30022 24.4008 4.40022 24.3008 3.90022 23.7008C3.40022 23.1008 3.50022 22.3008 4.10022 21.8008L4.20022 21.7008C4.30022 21.6008 4.40022 21.6008 4.50022 21.5008C5.80022 20.9008 7.20022 20.5008 8.60022 20.3008L6.40022 21.9008Z" fill="#F2F2F2" />
            </g>
            <g class="leaf_rapper">
            ...
            <g class="leaf_rapper">
              <path class="leaf" fill-rule="evenodd" clip-rule="evenodd" d="M11.8003 29.9004C11.1003 31.2004 10.6003 32.7004 10.4003 34.2004C10.4003 34.4004 10.3003 34.5004 10.3003 34.7004C10.3003 35.6004 11.1003 36.4004 12.0003 36.4004H12.1003C13.0003 36.4004 13.7003 35.7004 13.7003 34.8004V34.7004C13.7003 34.6004 13.7003 34.4004 13.6003 34.3004C13.3003 32.7004 12.7003 31.2004 11.8003 29.9004Z" fill="#F2F2F2" />
            </g>
          </g>
        ...
        <g class="bottom_leafs">
          ...
          <g class="leaf_rapper">
            <path class="leaf" fill-rule="evenodd" clip-rule="evenodd" d="M17.8003 39.4009H18.0003C19.4003 39.2009 20.6003 40.1009 21.0003 41.4009C21.1003 42.7009 20.2003 43.9009 18.9003 44.1009H18.1003C15.4003 44.0009 12.8003 43.5009 10.3003 42.7009C12.4003 41.2009 14.8003 40.1009 17.3003 39.4009H17.8003Z" fill="#F2F2F2" />
          </g>
        </g>
      </g>
      <g class="right_branch">
        <g class="stem_rapper">
          ...
          <g class="right">
            ...
            <g class="leaf_rapper">
              <path class="leaf" fill-rule="evenodd" clip-rule="evenodd" d="M52.6002 23.8008C51.1002 23.8008 49.5002 24.2008 48.1002 24.7008C47.9002 24.7008 47.8002 24.8008 47.7002 24.9008C46.9002 25.2008 46.6002 26.1008 46.9002 26.9008C47.4002 27.6008 48.3002 27.8008 49.0002 27.4008C50.4002 26.4008 51.6002 25.2008 52.6002 23.8008Z" fill="#F2F2F2" />
            </g>
            <g class="leaf_rapper">
              <path class="leaf" fill-rule="evenodd" clip-rule="evenodd" d="M52.3002 28.7994C51.1002 30.0994 49.7002 31.0994 48.2002 31.8994C48.1002 31.9994 48.0002 31.9994 47.9002 31.9994H47.7002C46.9002 32.2994 45.9002 31.8994 45.6002 31.0994C45.3002 30.2994 45.8002 29.3994 46.6002 29.0994C46.7002 29.0994 46.7002 29.0994 46.8002 29.0994C46.9002 29.0994 47.1002 28.9994 47.2002 28.9994C48.9002 28.5994 50.6002 28.4994 52.3002 28.7994Z" fill="#F2F2F2" />
            </g>
            <g class="leaf_rapper">
      ...
      <path class="one" d="M24.7002 13.7004L22.9002 15.5004L19.7002 12.3004L25.6002 6.40039H29.6002V28.8004H24.7002V13.7004Z" fill="#F2F2F2" />
    </g>
    <defs>
