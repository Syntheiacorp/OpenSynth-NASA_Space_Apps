...
<body>
  ...
  <!-- Start SignUp area -->
  <section class="signup-wrapper header-free-signin">
    <div class="signin-content">
      <form action="login.php" method="POST" class="signin-form signin-form-2">
        <div class="signin-header mb-6 text-center">
          <div class="logo logo-signin mb-3">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-6 mb-4">
            <div class="field-box text-sm-end">
          ...
          <div class="col-md-12 mb-4">
            <div class="field-box">
              <button class="btn btn-gradient w-100 justify-content-center btn-medium" name="submit" type="submit"><span>Sign
                  In</span></button>
            </div>
          </div>
          <!-- End .col -->
        ...
        <div class="signin-options">
          <div class="row justify-content-center text-center">
            ...
            <div class="col-lg-12">
              Don't have an account? <a href="../signup/" class="color-primary">Sign up</a>
            </div>
            <!-- End .col -->
          </div>
        </div>
