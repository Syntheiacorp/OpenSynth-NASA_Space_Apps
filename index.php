...
<body>
    ...
    <div class="container">
      ...
      <div class="slider top-seller-activation-1 slick-gutter-15 slick-arrow-between ">
        ...
        <div class="top-seller-style-one">
          ...
          <h4 class="title pb-1"><a href="author-profile.html">Hasina</a></h4>
          <span class="price">78.1 ETH</span>
        </div>
        <!-- End .col -->
        ...
        <div class="top-seller-style-one">
          ...
          <h4 class="title pb-1"><a href="author-profile.html">Monalisa</a></h4>
          <span class="price">24.6 ETH</span>
        </div>
        <!-- End .col -->
        ...
        <div class="top-seller-style-one">
          ...
          <h4 class="title pb-1"><a href="author-profile.html">James Tonny</a></h4>
          <span class="price">23 ETH</span>
        </div>
        <!-- End .col -->
        ...
        <div class="top-seller-style-one">
          ...
          <h4 class="title pb-1"><a href="author-profile.html">Jacklin</a></h4>
          <span class="price">45.6 ETH</span>
        </div>
        <!-- End .col -->
        ...
        <div class="top-seller-style-one">
          ...
          <h4 class="title pb-1"><a href="author-profile.html">Belly Dia</a></h4>
          <span class="price">22.6 ETH</span>
        </div>
        <!-- End .col -->
        ...
        <div class="top-seller-style-one">
          ...
          <h4 class="title pb-1"><a href="author-profile.html">Jankar Jio</a></h4>
          <span class="price">214.6 ETH</span>
        </div>
        <!-- End .col -->
        ...
        <div class="top-seller-style-one">
          ...
          <h4 class="title pb-1"><a href="author-profile.html">Kerion Ara</a></h4>
          <span class="price">214.6 ETH</span>
        </div>
        <!-- End .col -->
      </div>
  ...
  <section class="ptb-120 live-auction">
    <div class="container">
      <div class="section-title">
        <span class="subtitle">Auctions</span>
        <h2>Live Auctions</h2>
      </div>
      <!-- End .section-title -->
    </div>
    ...
    <div class="slider slick-activation-01 slick-gutter-15 slick-pagination-50  slick-arrow-top">
      <div class="explore-style-one">
        <div class="thumb">
          <a href="product-details.html"><img src="images/explore/4.jpg" alt="nft live auction thumbnail"></a>
          <div class="countdown btn btn-gradient btn-small" data-date="2022-10-10">
          </div>
          <!-- End .count-down -->
          <button class="reaction-btn"><i class="ri-heart-fill"></i><span>08</span></button>
          <!-- End .reaction-count -->
      ...
      <div class="explore-style-one">
        <div class="thumb">
          <a href="product-details.html"><img src="images/explore/5.jpg" alt="nft live auction thumbnail"></a>
          <div class="countdown btn btn-gradient btn-small" data-date="2022-12-13">
          </div>
          <!-- End .count-down -->
          <button class="reaction-btn"><i class="ri-heart-fill"></i><span>55</span></button>
          <!-- End .reaction-count -->
      ...
      <div class="explore-style-one">
        <div class="thumb">
          <a href="product-details.html"><img src="images/explore/3.jpg" alt="nft live auction thumbnail"></a>
          <div class="countdown btn btn-gradient btn-small" data-date="2022-12-14">
          </div>
          <!-- End .count-down -->
          <button class="reaction-btn"><i class="ri-heart-fill"></i><span>25</span></button>
          <!-- End .reaction-count -->
      ...
      <div class="explore-style-one">
        <div class="thumb">
          <a href="product-details.html"><img src="images/explore/7.jpg" alt="nft live auction thumbnail"></a>
          <div class="countdown btn btn-gradient btn-small" data-date="2022-12-02">
          </div>
          <!-- End .count-down -->
          <button class="reaction-btn"><i class="ri-heart-fill"></i><span>14</span></button>
          <!-- End .reaction-count -->
      ...
      <div class="explore-style-one">
        <div class="thumb">
          <a href="product-details.html"><img src="images/explore/12.jpg" alt="nft live auction thumbnail"></a>
          <div class="countdown btn btn-gradient btn-small" data-date="2022-12-06">
          </div>
          <!-- End .count-down -->
          <button class="reaction-btn"><i class="ri-heart-fill"></i><span>32</span></button>
          <!-- End .reaction-count -->
      ...
      <div class="explore-style-one">
        <div class="thumb">
          <a href="product-details.html"><img src="images/explore/1.jpg" alt="nft live auction thumbnail"></a>
          <div class="countdown btn btn-gradient btn-small" data-date="2022-12-09">
          </div>
          <!-- End .count-down -->
          <button class="reaction-btn"><i class="ri-heart-fill"></i><span>49</span></button>
          <!-- End .reaction-count -->
      ...
      <div class="explore-style-one">
        <div class="thumb">
          <a href="product-details.html"><img src="images/explore/2.jpg" alt="nft live auction thumbnail"></a>
          <div class="countdown btn btn-gradient btn-small" data-date="2022-12-09">
          </div>
          <!-- End .count-down -->
          <button class="reaction-btn"><i class="ri-heart-fill"></i><span>12</span></button>
      ...
      <div class="explore-style-one">
        <div class="thumb">
          <a href="product-details.html"><img src="images/explore/6.jpg" alt="nft live auction thumbnail"></a>
          <div class="countdown btn btn-gradient btn-small" data-date="2022-12-07">
          </div>
          <!-- End .count-down -->
          <button class="reaction-btn"><i class="ri-heart-fill"></i><span>19</span></button>
          <!-- End .reaction-count -->
